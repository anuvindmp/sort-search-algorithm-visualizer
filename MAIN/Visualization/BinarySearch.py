...
text2 = "value within asorted array. It works by repeatedly dividing the search range in half until the"
...
rec2 = "Set bounds to first and last indices,Loop until range is empty or target is found :"
