...
heading = fontHead.render("Linear Search", True, color1)

# opening paragraph
text1 = "Linear search is a simple searching algorithm that sequentially checks each element in a list"
text2 = "until a match is found or the entire list has been traversed.The time complexity of the linear"
text3 = "search algorithm is  O(n) "
...
# subheading
subheading = "Linear Search Algorithm"
subheadfont = pygame.font.Font(fontPath1, 25)
subheadSurface = subheadfont.render(subheading, True, color1)

# rectangle text
rec1 = "In Linear Search algorithm :"
rec2 = "• Start: Begin search from the first element."
rec21 = "• Compare: Check each element for a match."
rec3 = "• End: Repeat until match or end of list. "
rec4 = "• In the worst-case scenario, the algorithm may need to iterate through all n "
rec41 = "  elements in the list to find the target or determine that it is not present  "
