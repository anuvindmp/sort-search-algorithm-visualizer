...
class DFSVisualizer:
    def __init__(self, root, graph):
        ...
        self.search_button = tk.Button(root, text="Run DFS", command=self.start_dfs, fg="white", bg="#05161A", width=20)
...
def main():
    ...
    graph = Graph()
    visualizer = DFSVisualizer(root, graph)
    root.mainloop()
